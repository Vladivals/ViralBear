  ...
  name: 'filePhoto', maxCount: 1
    ...
    try{
      ...
      console.log(upload)
        ...
        console.log(req.body)
        const {title,description,tags,city,country,category,date,videoLink,videoId,lastModif,brandSafe}=req.body
        ...
        if (brandSafe){
          const video = new Video({
            videoId:videoId,
             ...
             mRSS:`        <item>\n          <media:title>${title}</media:title>\n          <media:description>${description}</media:description>\n          <media:keywords>${tags}</media:keywords>\n          <media:city>${city}</media:city>\n          <media:country>${country}</media:country>\n          <media:category>${category}</media:category>\n          <media:filmingDate>${date}</media:filmingDate>\n          <guid>${videoId} </guid>\n          <media:youtubeLink>${videoLink}</media:youtubeLink>\n          <pubDate>${date}</pubDate>\n          <media:thumbnail url="${upload[1].Location}" />\n          <media:content url="${upload[0].Location}" />\n          <dfpvideo:lastModifiedDate>${lastModif}</dfpvideo:lastModifiedDate>\n          <dfpvideo:lastMediaModifiedDate>${lastModif}</dfpvideo:lastMediaModifiedDate>\n        </item>`,
            data:{
                title,description,tags,brandSafe,city,country,category,date,videoId,videoLink,downloadVideo:upload[0].Location,downloadPhoto:upload[1].Location,lastModif,
        ...
        await video.save()
          ...
          const video = new Video({
            ...
            mRSS:`        <item>\n          <media:title>${title}</media:title>\n          <media:description>${description}</media:description>\n          <media:keywords>${tags}</media:keywords>\n          <media:city>${city}</media:city>\n          <media:country>${country}</media:country>\n          <media:category>${category}</media:category>\n          <media:filmingDate>${date}</media:filmingDate>\n          <guid>${videoId} </guid>\n          <media:youtubeLink>${videoLink}</media:youtubeLink>\n          <pubDate>${date}</pubDate>\n          <media:thumbnail url="${upload[1].Location}" />\n          <media:content url="${upload[0].Location}" />\n          <dfpvideo:lastModifiedDate>${lastModif}</dfpvideo:lastModifiedDate>\n          <dfpvideo:lastMediaModifiedDate>${lastModif}</dfpvideo:lastMediaModifiedDate>\n        </item>`,
            data:{
                title,description,brandSafe,tags,city,country,category,date,videoId,videoLink,downloadVideo:upload[0].Location,downloadPhoto:upload[1].Location,lastModif,
